...
void SPI_MasterInit(void)
{
    ...
    SPCR = (1 << SPIE)|(1 << SPE)|(0 << DORD)|(1 << MSTR)|(0 << CPOL)|(0 << CPHA)|(0 << SPR1)|(1 << SPR0);//вкл SPI, ведущий, частота fck/16
}

//Функция инициализации МК Ведомым
void SPI_SlaveInit(void)
{
    SPI_DDRX = (1 << SPI_MISO)|(0 << SPI_MOSI)|(0 << SPI_SCK)|(0 << SPI_SS);//настраиваем на выход MISO, остальные на вход
